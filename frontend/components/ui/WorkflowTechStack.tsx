...
const WORKFLOW_STEPS = [
  {
    ...
    bgBadge: 'bg-sky-500/10 border-sky-400/30 text-sky-200',
  ...
  },
  {
    ...
    bulletPoints: [
      'Safe Touchdown Zones (Low Risk)',
      'Cautionary Terrain Zones (Medium Risk)',
  ...
  },
  {
    ...
    bulletPoints: [
      ...
      'Simulate lander navigation trajectory in 3D'
    ],
