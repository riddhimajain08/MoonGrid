  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 flex flex-col justify-between min-h-screen transition-opacity duration-700 pointer-events-none ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
        ...
        {/* Live Mission Control Ticker */}
        <div className="interactive pointer-events-auto w-full overflow-hidden bg-slate-950/80 border-b border-cyan-500/20 backdrop-blur-md z-30 py-1.5 px-4">
          <div className="flex items-center gap-4 text-[0.65rem] font-mono whitespace-nowrap overflow-hidden">
            <div className="flex items-center gap-2 text-cyan-400 font-bold bg-cyan-950/60 px-2 py-0.5 rounded border border-cyan-500/30 flex-shrink-0">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping"></span>
              <span>MISSION CONTROL STATUS: ONLINE</span>
            </div>

            <div className="animate-marquee flex items-center gap-8 text-gray-300">
              <span className="flex items-center gap-1.5">
                <span className="text-cyan-400">🛰️ TMC COVERAGE:</span> 80% (5m Resolution)
              </span>
              <span className="text-gray-600">•</span>
              <span className="flex items-center gap-1.5">
                <span className="text-purple-400">🔍 OHRC GROUND TRUTH:</span> 25cm High Precision
              </span>
              <span className="text-gray-600">•</span>
              <span className="flex items-center gap-1.5">
                <span className="text-emerald-400">⚡ AI SUPER-RES:</span> SwinIR Transformer Active
              </span>
              <span className="text-gray-600">•</span>
              <span className="flex items-center gap-1.5">
                <span className="text-amber-400">⚠️ HAZARD DETECTION:</span> Slope ≥10° | Craters | Boulders | Shadows
              </span>
              <span className="text-gray-600">•</span>
              <span className="flex items-center gap-1.5">
                <span className="text-blue-400">🗺️ RISK MAP ENGINE:</span> 1m Grid Cell Fusion
              </span>
              <span className="text-gray-600">•</span>
              <span className="flex items-center gap-1.5">
                <span className="text-teal-400">🗄️ SPATIAL DB:</span> PostGIS EPSG:30100 Connected
              </span>
              <span className="text-gray-600">•</span>
              <span className="flex items-center gap-1.5">
                <span className="text-rose-400">🎯 ACTIVE CANDIDATES:</span> 4 Polar &amp; Mare Landing Zones
              </span>
              <span className="text-gray-600">•</span>
